CLASS zcl_ctsw_diff DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_ctsw_diff IMPLEMENTATION.
  ...
  METHOD unpack.
    ...
    lv_new = zcl_ctsw_convert=>xstring_to_string_utf8( iv_new ).
    lv_old = zcl_ctsw_convert=>xstring_to_string_utf8( iv_old ).
