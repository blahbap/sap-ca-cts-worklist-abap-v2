class ZCL_CTSW_TR_VERSIONS definition
  public
  final
  create public .
...
CLASS ZCL_CTSW_TR_VERSIONS IMPLEMENTATION.
...
*-----------------------------------------------------------------------
    ...
    DATA: ls_page_difference TYPE  zcl_ctsw_compare_code=>ty_file_diff,
          ls_file2           TYPE  zcl_ctsw_compare_code=>ty_file_diff.
    ...
    DATA(lo_html) = zcl_ctsw_compare_code=>render_diff_public( ls_page_difference ).
