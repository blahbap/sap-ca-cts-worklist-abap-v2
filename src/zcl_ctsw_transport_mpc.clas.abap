class ZCL_CTSW_TRANSPORT_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_CTSW_TRANSPORT_MPC========CP' ##NO_TEXT.
...
CLASS ZCL_CTSW_TRANSPORT_MPC IMPLEMENTATION.
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_CTSW_TRANSPORT_MPC=>TS_RELEASE' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_CTSW_TRANSPORT_MPC=>TS_RETURNCODE' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20201013130606'.                  "#EC NOTEXT
